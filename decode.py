...
if __name__=="__main__":
  ...
  optparser.add_option("-e", "--eta", dest="eta", default=1.0, type="float", help="Eta Value for distortion model (default=1.0)")
  optparser.add_option("-d", "--distort", dest="distort", default=6, type="int", help="Maximum distortion length (default=6)")
